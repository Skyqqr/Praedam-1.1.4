:: This Version of praedam (Mini) was made on 03/17/2018!
:: ==============================================
:: VERSION 1.1.4 WAS MADE BY SKYQQR AND L.
:: ==============================================
...
:: actually have this version for download, well anyways, this version (1.1.4 pre)
:: should be the main and newest version, atleast at the time of writing. You can find more information
:: about this (or the newest if i get around to writing one) version at https://github.com/Skyqqr/Praedam-Game
::
::TODO: Check if all variables are actually used, and if not, remove them
::
@echo off
set b123=114
color 0e
...
cls
color 0e
if %plyhp% GTR %maxplyhp% set plyhp=%maxplyhp%
...
echo [===================[Mini]====================]
echo [ 1) Battle 2) Store 3) Eat Savedfood 4) Quit ]
echo [=============================================]
...
if %input%==3 goto Etsf
if %input%==varsee goto varsee
echo.
...
timeout 2 >nul
set /a mobatk=%random% %% 6
if %mobatk%==0 goto mobskipatk
if %mobatk%==6 goto mobskipatk
if %mobatk%==1 (
...
goto hub
    ...
    :restart
cls
echo Are you sure you want to restart your game? Losing all your saved progress?
echo  1) Yes 2) No
echo.
set /p input=Player:
if %input%==1 (
...
echo.
echo.
set /a IGMN2=%IGMN%*%stacksize%
echo [=============================]
echo  You have gotten a/an %IGname%! 
echo [=============================]
echo Would you like to Sell, Save or Eat? 
echo [=============================]
echo [ 1) Sell        WORTH: %IGMN2%G  
echo [ 2) Save                     
echo [ 3) Eat                      
echo [=============================]
set /p input=Player:
if %input%==1 (
set /a plymn=%plymn%+%IGMN%*%stacksize%
color 0a
cls
echo +%IGMN2% Money!
pause >nul
...
if %input%==2 (
set /a %foodslot%=%%foodslot%%+1
cls
color 0a
echo +%stacksize% %IGname%
pause >nul

    :getitem
cls
if %IGTYPE%==FOOD goto getfood
color 0e
echo.
echo.
echo.
...
echo %plyhp% Plyhp
echo %plyar% Plyar
echo %plyarne% Plyarne
echo %plywp% Plywp
echo %plywpne% Plywpne
echo %plydm% Plydm
echo %plycritdmg% Plycritdmg
echo %plycritnum% Plycritnum
echo %s1% s1
echo %s2% s2
echo %s3% s3
echo %s4% s4
